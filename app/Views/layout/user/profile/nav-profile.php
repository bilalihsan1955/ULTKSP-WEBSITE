    ...
    <div class="min-h-screen flex flex-col">
        ...
        <div class="flex flex-1 relative">
            ...
            <aside id="sidebar"
                ...
                <a href="<?= base_url('Dashboard/Profile/' . $user['username']) ?>"
                    class="text-[#ee4645] bg-[#fee2e2] backdrop-blur-sm rounded-r-lg text-xl focus:text-pink-700 focus:bg-[#fee2e2] w-full py-6 transition duration-300 flex justify-center transition-transform duration-300 hover:scale-125">
                    <button class="w-full h-full">
                        <span class="material-symbols-rounded">person</span>
                    </button>
                </a>
                <a href=""
                    class="signout-btn bg-slate-50/20 text-gray-500 rounded-r-lg text-xl hover:text-[#ee4645] focus:text-pink-700 hover:bg-[#fef2f2]/40 focus:bg-[#fee2e2] w-full py-6 transition duration-300 flex justify-center transition-transform duration-300 hover:scale-125">
                    <button class="w-full h-full">
