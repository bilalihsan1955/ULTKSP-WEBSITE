        ...
        <div class="p-2 md:p-12">
            <div
                ...
                <div
                    ...
                    ?>
                    <a href="<?= base_url('Dashboard/Edit-Report/' . 'Edit-' . url_title(ucwords($laporan['subject'])) . '/' . $encryptedLaporanId) ?>"
            ...
            <div class="p-6">
                ...
                ?>
                    <?php foreach ($comments as $comment) { ?>
                        ...
                        ?>
                            <?php if ($comment['user_id'] == $user['id'] && $user['role'] == 'user') { // Comment by current user 
                            ?>
                                <div class="mb-12">
                                    ...
                                    <div class="text-gray-700 bg-slate-50 rounded shadow-lg shadow-slate-100 mb-12 mt-4 py-4 px-10 border-r-4 border-[#F98B88]">
                                        ...
                                        <div class="flex items-center justify-end mb-2 mt-6">
                                            <a href="" onclick="confirmDeleteComment('<?= ('Dashboard/Delete-Comment/' . $encryptedcommentId) ?>')"
                ...
                ?>
                <form id="comment-form" class="user" action="<?= base_url('Dashboard/Post-Comment/' . $encryptedLaporanId) ?>" method="post">
                    <?= csrf_field() ?>
                    <div class="col-span-full form-group mb-6">
                        <label for="Isi" class="block text-gray-600 mb-2 text-md font-bold">Kirim Pesan ke
                            Bu Susi</label>
